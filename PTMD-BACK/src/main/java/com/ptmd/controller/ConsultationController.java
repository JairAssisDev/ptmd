...
public class ConsultationController {
    ...
    @Operation(summary = "Criar consulta", description = "Cria uma nova consulta com paciente e imagem. " +
            "A imagem é enviada para o microsserviço Python de IA que retorna um diagnóstico preliminar.")
    @ApiResponses(value = {
